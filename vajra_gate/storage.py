...
class HspStorage:
    ...
    async def store_file(self, file_data: bytes, filename: str, user_id: str = "default") -> str:
        ...
        create_document(doc_id, f"[File: {filename}]", user_id=user_id)
    ...
    def list_documents(self, user_id: str = "default") -> list[dict]:
        """List all stored documents with metadata."""
        return list_document_info(user_id=user_id)

    def get_document(self, doc_id: str, user_id: str = "default") -> str:
        """Get document content by ID."""
        return get_document(doc_id, user_id=user_id)
